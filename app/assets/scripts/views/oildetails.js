...
var OilDetails = BaseView.extend({
  ...
  createChartData: function () {
    ...
    var defaultModelData = {
      ...
      prelim: Oci.Collections.prelim.get(utils.getPRELIMModel('100', '0 = Default', '1')).toJSON()
    };
    ...
    var prelimRun = utils.getPRELIMModel(params.hydrogen, params.refinery, params.lpg);
